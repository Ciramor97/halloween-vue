...
<template>
  <nav class="flex items-center justify-between h-32">
    ...
    <div class="flex items-center gap-10">
      <a class="text-white text-lg font-medium" href="#home">Home</a>
      <a class="text-white text-lg font-medium" href="#category">Category</a>
      <a class="text-white text-lg font-medium" href="#about">About</a>
      <a class="text-white text-lg font-medium" href="#trick-or-treat"
        >Trick or Treat</a
      >
      <button
        class="px-8 py-3 rounded-full bg-secondary shadow shadow-secondary/30 text-white text-base font-medium tracking-wider"
      >
        DONATE
      </button>
    </div>
