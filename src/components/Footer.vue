  ...
  <footer id="scroll">
    <div class="grid grid-cols-2 gap-28">
      <div class="space-y-5">
        ...
        <p class="text-white leading-loose tracking-wide w-[80%]">
          ...
          fringilla ultricies eget amet blandit quis sit duis. Suspendisse fames
          venenatis volutpat urna dui. Quisque non diam mi ullamcorper.
        </p>
        <img
      ...
      <div class="grid grid-cols-3 text-white gap-12">
        <div>
        ...
        <div>
          <h3 class="mb-4 font-bold text-lg">Service</h3>
          <div class="flex flex-col gap-3">
    ...
    <div class="grid place-items-center w-full my-20">
      <div class="flex items-center gap-10">
        <a
          href="#"
          class="bg-secondary rounded-md h-12 w-12 grid place-items-center"
        >
        ...
        <a
          ...
          class="bg-secondary rounded-md h-12 w-12 grid place-items-center"
        >
          <img src="../assets/images/social/ig.svg" alt="" />
        </a>
        <a
          href="#"
          class="bg-secondary rounded-md h-12 w-12 grid place-items-center"
        >
          <img src="../assets/images/social/tw.svg" alt="" />
        </a>
      </div>
      <p class="text-lg font-medium text-center text-white mt-8 tracking-wider">
